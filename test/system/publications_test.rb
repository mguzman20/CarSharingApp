...
class PublicationsTest < ApplicationSystemTestCase
  ...
  test "creating a Publication" do
    ...
    fill_in "Dia", with: @publication.dia
    fill_in "Direccion", with: @publication.direccion
    fill_in "Hora", with: @publication.hora
    fill_in "Limite", with: @publication.limite
    fill_in "Salida", with: @publication.salida
    fill_in "Tipo", with: @publication.tipo
